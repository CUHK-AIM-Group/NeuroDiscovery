...
VERSION = 'kg.accepted_claim_layer.v4'
...
class AcceptedClaimLayer(AcceptedClaimEvidence):
    ...
    def _ensure_current(self):
        ...
        if fp:
            ...
            require(layer.get('schema') in {VERSION, 'kg.accepted_claim_layer.v3', 'kg.accepted_claim_layer.v2', 'kg.accepted_claim_layer.v1'} and layer.get('status') == 'ACCEPTED', 'Claim layer is not accepted')
            ...
            from core.web.claim_layer_extension_v3 import extend_base
