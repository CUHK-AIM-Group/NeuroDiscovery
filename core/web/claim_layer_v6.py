...
The v5 loader, projection, single-query path and scientific gates are unchanged.
...
from core.web.claim_layer_v5 import AcceptedClaimLayer as PreviousLayer, require
