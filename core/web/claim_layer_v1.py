...
VERSION = 'kg.accepted_claim_layer.v1'
...
class AcceptedClaimLayer(AcceptedClaimEvidence):
    ...
    def _ensure_current(self):
        ...
        if fp:
            ...
            require(layer.get('schema') == VERSION and layer.get('status') == 'ACCEPTED', 'Claim layer is not accepted')
            ...
            self._layer_fp = fp
            self._layer_inputs = [layer['projection'], *layer.get('review_inputs', [])]
