...
VERSION = 'kg.multipaper_claims.r83.v1'
APPROVED_RULESET_DIGEST = '0db62cc7046e85ae1d02e99a93fe43f4f13f13be3d9a3953c35d1260ce6f2f1a'
...
class MultipaperTransform(RootTransform):
    def __init__(self, claims, edges, deleted_claims, deleted_edges, new_nodes, entity_events):
        if deleted_claims or deleted_edges or entity_events:
            raise ValueError('R83 preserves all existing entities and observations')
...
def apply_multipaper_reimport(kg,claim):
    policy=kg.serialization_metadata.get('multipaper_claim_alignment')
