...
VERSION = 'kg.multipaper_claims.r82.v1'
APPROVED_RULESET_DIGEST = '750a7fd896760bca6a8a59abe35fe3fad993c1200ea2b7653b5a760ac4ad32e0'
...
class MultipaperTransform(RootTransform):
    def __init__(self, claims, edges, deleted_claims, deleted_edges, new_nodes, entity_events):
        if deleted_claims or deleted_edges or entity_events:
            raise ValueError('R82 preserves all existing entities and observations')
...
def apply_multipaper_reimport(kg,claim):
    policy=kg.serialization_metadata.get('multipaper_claim_convergence')
