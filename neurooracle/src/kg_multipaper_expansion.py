...
VERSION = 'kg.multipaper_claims.r77.v1'
APPROVED_RULESET_DIGEST = 'ec5ab3e64333838df7b6f58c6949c5e27b0aabd498effa08474b3e15ed8a666b'
...
class MultipaperTransform(RootTransform):
    def __init__(self, claims, edges, deleted_claims, deleted_edges, new_nodes, entity_events):
        if deleted_claims or deleted_edges or entity_events:
            raise ValueError('R77 preserves all existing entities and observations')
...
def apply_multipaper_reimport(kg,claim):
    policy=kg.serialization_metadata.get('multipaper_claim_expansion')
