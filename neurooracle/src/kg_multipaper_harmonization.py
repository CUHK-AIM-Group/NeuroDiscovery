...
VERSION = 'kg.multipaper_claims.r85.v1'
APPROVED_RULESET_DIGEST = '9336cb6b82f5848f5e056cc39c82095708b816a4ab1eddfd3eeacf4e94bf1600'
...
class MultipaperTransform(RootTransform):
    def __init__(self, claims, edges, deleted_claims, deleted_edges, new_nodes, entity_events):
        if deleted_claims or deleted_edges or entity_events:
            raise ValueError('R85 preserves all existing entities and observations')
...
def apply_multipaper_reimport(kg,claim):
    policy=kg.serialization_metadata.get('multipaper_claim_harmonization')
