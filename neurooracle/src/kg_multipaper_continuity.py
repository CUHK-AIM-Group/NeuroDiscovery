...
VERSION = 'kg.multipaper_claims.r92.v1'
APPROVED_RULESET_DIGEST = 'b35d14705ddcd49ddcccf9dae8563453bad48d7263633f9632b067614971e54e'
...
class MultipaperTransform(RootTransform):
    def __init__(self, claims, edges, deleted_claims, deleted_edges, new_nodes, entity_events):
        if deleted_claims or deleted_edges or entity_events:
            raise ValueError('R92 preserves all existing entities and observations')
...
def apply_multipaper_reimport(kg,claim):
    policy=kg.serialization_metadata.get('multipaper_claim_continuity')
