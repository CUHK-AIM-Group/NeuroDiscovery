...
VERSION = 'kg.multipaper_claims.r80.v1'
APPROVED_RULESET_DIGEST = 'f1849d8e0761707696111ed3bcd45eb7f03a0fd58fe36d18c97e3364252906fc'
...
class MultipaperTransform(RootTransform):
    def __init__(self, claims, edges, deleted_claims, deleted_edges, new_nodes, entity_events):
        if deleted_claims or deleted_edges or entity_events:
            raise ValueError('R80 preserves all existing entities and observations')
...
def apply_multipaper_reimport(kg,claim):
    policy=kg.serialization_metadata.get('multipaper_claim_aliases')
