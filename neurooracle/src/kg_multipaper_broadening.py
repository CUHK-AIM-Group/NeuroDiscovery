...
VERSION = 'kg.multipaper_claims.r79.v1'
APPROVED_RULESET_DIGEST = 'c805b566a1c853f4d5b45dbf51ad3123c0406d7c862a0a049a1f2fd2927d7262'
...
class MultipaperTransform(RootTransform):
    def __init__(self, claims, edges, deleted_claims, deleted_edges, new_nodes, entity_events):
        if deleted_claims or deleted_edges or entity_events:
            raise ValueError('R79 preserves all existing entities and observations')
...
def apply_multipaper_reimport(kg,claim):
    policy=kg.serialization_metadata.get('multipaper_claim_broadening')
