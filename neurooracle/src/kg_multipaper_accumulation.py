...
VERSION = 'kg.multipaper_claims.r88.v1'
APPROVED_RULESET_DIGEST = '6b971c5157665c216603d885cf904d04d02dc84abccb3626676aa66699c88566'
...
class MultipaperTransform(RootTransform):
    def __init__(self, claims, edges, deleted_claims, deleted_edges, new_nodes, entity_events):
        if deleted_claims or deleted_edges or entity_events:
            raise ValueError('R88 preserves all existing entities and observations')
...
def apply_multipaper_reimport(kg,claim):
    policy=kg.serialization_metadata.get('multipaper_claim_accumulation')
