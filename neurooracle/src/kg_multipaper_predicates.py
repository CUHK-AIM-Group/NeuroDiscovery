...
VERSION = 'kg.multipaper_claims.r81.v1'
APPROVED_RULESET_DIGEST = '9f88eb381303fda8cc483117faab76e85dc8acbbf9918efd7f245a37479ef9d4'
...
class MultipaperTransform(RootTransform):
    def __init__(self, claims, edges, deleted_claims, deleted_edges, new_nodes, entity_events):
        if deleted_claims or deleted_edges or entity_events:
            raise ValueError('R81 preserves all existing entities and observations')
...
def apply_multipaper_reimport(kg,claim):
    policy=kg.serialization_metadata.get('multipaper_claim_predicates')
