...
VERSION = 'kg.multipaper_claims.r86.v1'
APPROVED_RULESET_DIGEST = 'db897547b1a129505a238d370834ce4691404c9b32c315d070eb92b180f604eb'
...
class MultipaperTransform(RootTransform):
    def __init__(self, claims, edges, deleted_claims, deleted_edges, new_nodes, entity_events):
        if deleted_claims or deleted_edges or entity_events:
            raise ValueError('R86 preserves all existing entities and observations')
...
def apply_multipaper_reimport(kg,claim):
    policy=kg.serialization_metadata.get('multipaper_claim_integration')
