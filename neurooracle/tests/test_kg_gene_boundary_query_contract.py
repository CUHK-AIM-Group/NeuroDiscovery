...
from publish_kg_gene_boundary_query_contract import flags_from_completed_proof,CAPABILITIES
...
def fixture():
    ...
    r=dict(status="CURRENT_GENE_BOUNDARY_REPAIR_APPLIED",graph={"sha256":"proof"},checks=checks,code=["frozen"],counts={"claims":3})
